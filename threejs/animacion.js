...
function setupGUI()
{
    ...
    folder.add(effectControl, "mensaje").name("Aplication");
    folder.add(effectControl, "posY", 1.0,3.0,0.1).name("Sube/Baja");
    folder.add(effectControl, "separacion", {Ninguna:0, Media:1, Maxima:2}).name("a");
    folder.add(effectControl, "caja").name("Ver Esfera");
    folder.add(effectControl, "color").name("Color Esfera");
}
